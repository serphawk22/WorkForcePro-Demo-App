...
const STATIC_FEATURES: ExtendedSearchResult[] = [
  ...
  },
  {
    ...
    subtitle: "Workspaces, nodes and tasks",
    type: "Feature",
    keywords: ["projects", "tasks", "workspace", "nodes", "board", "jira"],
  ...
  },
  {
    id: "feat_3",
    title: "Weekly Report",
    subtitle: "Auto-generated weekly summary",
    type: "Feature",
    keywords: ["weekly", "report", "summary", "sheet"],
    route: "/my-space/weekly-sheet",
    priority_score: 90,
  },
  {
    id: "feat_6",
