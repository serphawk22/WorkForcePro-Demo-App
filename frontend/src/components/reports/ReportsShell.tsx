...
const TABS = [
  { label: "Task Sheet", path: "/reports/task-sheet" },
  { label: "Happy Sheet", path: "/reports/happy-sheet" },
  { label: "Weekly Sheet", path: "/reports/weekly-sheet" },
];
...
export default function ReportsShell({ children, headerAction }: ReportsShellProps) {
  const { user } = useAuth();
            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-sm mt-0.5 text-[#854F6C] dark:text-purple-400">
                  Track team performance, tasks, and reflections
                </p>
              </div>
