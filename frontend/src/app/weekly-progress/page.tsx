...
export default function WeeklyProgressPage() {
  ...
  return (
    <ProtectedRoute allowedRoles={["employee"]}>
      <DashboardLayout role="employee" userName={user?.name} userHandle={user?.email}>
        <div className="space-y-4 pb-8">
          <div>
            <h1 className="text-2xl font-bold text-foreground">Weekly Progress</h1>
            <p className="text-sm text-muted-foreground mt-1">Submit updates and review admin feedback.</p>
          </div>
